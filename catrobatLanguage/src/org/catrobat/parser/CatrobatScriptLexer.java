...
public class CatrobatScriptLexer extends Lexer {
	...
	public static final String[] tokenNames = {
		"<INVALID>",
		"'left'", "'stop'", "'Y:'", "'X:'", "'to'", "'I'", "'by'", "'size'", "'sound'", 
		"'next'", "'brightness'", "'%'", "'variable'", "'on'", "'turn'", "'glide'", 
		"'seconds'", "'X'", "'duration:'", "'steps'", "'place'", "'repeat'", "'started'", 
		"'effect'", "'at'", "'back'", "'broadcast'", "'when'", "'direction'", 
		"'edge'", "'move'", "'look'", "'hide'", "'degrees'", "'forever'", "'in'", 
		"'of'", "'receive'", "'if'", "'note'", "'program'", "'change'", "'volume'", 
		"'Y'", "'bounce'", "'set'", "'all'", "'wait'", "'and'", "'speed'", "'else'", 
		"'sounds'", "'motor'", "'true'", "'go'", "'effects'", "'tone'", "'is'", 
		"'NXT'", "'loop'", "'clear'", "'layers'", "'frequency:'", "'ghost'", "'start'", 
		"'come'", "'show'", "'speak'", "'front'", "'right'", "'then'", "'play'", 
		"'switch'", "'graphic'", "'end'", "'point'", "USER_VARIABLE", "NUMBER", 
		"FUNCTION_NAME", "OPERATOR", "SENSOR", "'('", "')'", "','", "'Tapped'", 
		"WS"
	};
	public static final String[] ruleNames = {
		...
		"T__2", "T__1", "T__0", "USER_VARIABLE", "NUMBER", "FUNCTION_NAME", "OPERATOR", 
		"SENSOR", "BRACKET_OPEN", "BRACKET_CLOSE", "FUNCTION_PARAMETER_DELIMITER", 
		"ACTION", "WS", "STRING", "OPERATOR_SYMBOL", "ADDITIONAL_SYMBOL", "SYMBOL", 
		"DIGIT", "LETTER"
	};
	...
	public static final String _serializedATN =
		"\2\4X\u03ab\b\1\4\2\t\2\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t"+
		...
		".<=BB]]__aa}}\177\u0080\4C\\c|\u03d4\2\3\3\2\2\2\2\5\3\2\2\2\2\7\3\2\2"+
		...
		"\5\u00b5[\2\u039a\u039d\5\u00b1Y\2\u039b\u039d\5\u00adW\2\u039c\u0397"+
		"\3\2\2\2\u039c\u0398\3\2\2\2\u039c\u0399\3\2\2\2\u039c\u039a\3\2\2\2\u039c"+
