...
public class CatrobatScriptParser extends Parser {
	...
	public static final int RULE_program = 0, RULE_startScript = 1,
			...
			RULE_moveNStepsBrick = 30, RULE_nextLookBrick = 31,
			...
			RULE_speakBrick = 47, RULE_stopAllSoundsBrick = 48,
			RULE_turnLeftBrick = 49, RULE_turnRightBrick = 50,
			RULE_waitBrick = 51, RULE_action = 52, RULE_formula = 53,
			RULE_look = 54, RULE_sound = 55, RULE_objectName = 56,
			RULE_message = 57, RULE_motor = 58, RULE_textField = 59,
	...
	public static final String[] ruleNames = { "program", "startScript",
			...
			"nextLookBrick", "noteBrick", "placeAtBrick", "playSoundBrick",
			...
			"setXBrick", "setYBrick", "showBrick", "speakBrick",
			"stopAllSoundsBrick", "turnLeftBrick", "turnRightBrick",
			"waitBrick", "action", "formula", "look", "sound", "objectName",
			"message", "motor", "textField", "userVariable", "token" };
				...
				while (_la == 28) {
					{
						...
						case 1: {
							setState(124);
							((ProgramContext) _localctx).startScript = startScript();
							scriptList
									.add(((ProgramContext) _localctx).startScript.value);
						}
							break;

						case 2: {
							setState(127);
							((ProgramContext) _localctx).whenScript = whenScript();
							scriptList
									.add(((ProgramContext) _localctx).whenScript.value);
						}
							break;

						case 3: {
							setState(130);
							((ProgramContext) _localctx).broadcastScript = broadcastScript();
							scriptList
									.add(((ProgramContext) _localctx).broadcastScript.value);
						}
							break;
						}
					}
	...
	public final StartScriptContext startScript() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				setState(142);
				((StartScriptContext) _localctx).brickList = brickList();
			...
			{
				{
					...
					match(28);
					setState(146);
					((WhenScriptContext) _localctx).action = action();
				}
				setState(148);
				((WhenScriptContext) _localctx).brickList = brickList();
			...
			{
				{
					...
					match(38);
					setState(154);
					((BroadcastScriptContext) _localctx).message = message();
				}
				setState(156);
				((BroadcastScriptContext) _localctx).brickList = brickList();
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2)
						| (1L << 10) | (1L << 15) | (1L << 16) | (1L << 21)
						| (1L << 22) | (1L << 27) | (1L << 31) | (1L << 33)
						| (1L << 35) | (1L << 39) | (1L << 40) | (1L << 42)
						| (1L << 46) | (1L << 48) | (1L << 51) | (1L << 55)
						| (1L << 59) | (1L << 61))) != 0)
						|| ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65))
								| (1L << (66 - 65))
								| (1L << (67 - 65))
								| (1L << (68 - 65))
								| (1L << (73 - 65))
								| (1L << (75 - 65)) | (1L << (76 - 65)))) != 0)) {
					{
						{
							setState(159);
							((BrickListContext) _localctx).brick = brick();
							brickList
									.add(((BrickListContext) _localctx).brick.value);
						}
					}
					setState(166);
					_errHandler.sync(this);
	...
	public final BrickContext brick() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
					setState(167);
					((BrickContext) _localctx).broadcastBrick = broadcastBrick();
			...
			case 2:
				...
				{
					setState(170);
					((BrickContext) _localctx).broadcastWaitBrick = broadcastWaitBrick();
			...
			case 3:
				...
				{
					setState(173);
					((BrickContext) _localctx).changeBrightnessByNBrick = changeBrightnessByNBrick();
			...
			case 4:
				...
				{
					setState(176);
					((BrickContext) _localctx).changeGhostEffectByNBrick = changeGhostEffectByNBrick();
			...
			case 5:
				...
				{
					setState(179);
					((BrickContext) _localctx).changeSizeByNBrick = changeSizeByNBrick();
			...
			case 6:
				...
				{
					setState(182);
					((BrickContext) _localctx).changeVariableBrick = changeVariableBrick();
			...
			case 7:
				...
				{
					setState(185);
					((BrickContext) _localctx).changeVolumeByNBrick = changeVolumeByNBrick();
			...
			case 8:
				...
				{
					setState(188);
					((BrickContext) _localctx).changeXByNBrick = changeXByNBrick();
			...
			case 9:
				...
				{
					setState(191);
					((BrickContext) _localctx).changeYByNBrick = changeYByNBrick();
			...
			case 10:
				...
				{
					setState(194);
					((BrickContext) _localctx).clearGraficEffectBrick = clearGraficEffectBrick();
			...
			case 11:
				...
				{
					setState(197);
					((BrickContext) _localctx).comeToFrontBrick = comeToFrontBrick();
			...
			case 12:
				...
				{
					setState(200);
					((BrickContext) _localctx).foreverBrick = foreverBrick();
			...
			case 13:
				...
				{
					setState(203);
					((BrickContext) _localctx).glideToBrick = glideToBrick();
			...
			case 14:
				...
				{
					setState(206);
					((BrickContext) _localctx).goNStepsBackBrick = goNStepsBackBrick();
			...
			case 15:
				...
				{
					setState(209);
					((BrickContext) _localctx).hideBrick = hideBrick();
			...
			case 16:
				...
				{
					setState(212);
					((BrickContext) _localctx).ifLogicBeginBrick = ifLogicBeginBrick();
			...
			case 17:
				...
				{
					setState(215);
					((BrickContext) _localctx).ifLogicElseBrick = ifLogicElseBrick();
			...
			case 18:
				...
				{
					setState(218);
					((BrickContext) _localctx).ifLogicEndBrick = ifLogicEndBrick();
			...
			case 19:
				...
				{
					setState(221);
					((BrickContext) _localctx).ifOnEdgeBounceBrick = ifOnEdgeBounceBrick();
			...
			case 20:
				...
				{
					setState(224);
					((BrickContext) _localctx).legoNXTMotorActionBrick = legoNXTMotorActionBrick();
			...
			case 21:
				...
				{
					setState(227);
					((BrickContext) _localctx).legoNxtMotorStopBrick = legoNxtMotorStopBrick();
			...
			case 22:
				...
				{
					setState(230);
					((BrickContext) _localctx).legoNxtMotorTurnAngleBrick = legoNxtMotorTurnAngleBrick();
			...
			case 23:
				...
				{
					setState(233);
					((BrickContext) _localctx).legoNxtPlayToneBrick = legoNxtPlayToneBrick();
			...
			case 24:
				...
				{
					setState(236);
					((BrickContext) _localctx).loopEndBrick = loopEndBrick();
			...
			case 25:
				...
				{
					setState(239);
					((BrickContext) _localctx).moveNStepsBrick = moveNStepsBrick();
			...
			case 26:
				...
				{
					setState(242);
					((BrickContext) _localctx).nextLookBrick = nextLookBrick();
			...
			case 27:
				...
				{
					setState(245);
					((BrickContext) _localctx).noteBrick = noteBrick();
			...
			case 28:
				...
				{
					setState(248);
					((BrickContext) _localctx).placeAtBrick = placeAtBrick();
			...
			case 29:
				...
				{
					setState(251);
					((BrickContext) _localctx).playSoundBrick = playSoundBrick();
			...
			case 30:
				...
				{
					setState(254);
					((BrickContext) _localctx).pointInDirectionBrick = pointInDirectionBrick();
			...
			case 31:
				...
				{
					setState(257);
					((BrickContext) _localctx).pointToBrick = pointToBrick();
			...
			case 32:
				...
				{
					setState(260);
					((BrickContext) _localctx).repeatBrick = repeatBrick();
			...
			case 33:
				...
				{
					setState(263);
					((BrickContext) _localctx).setBrightnessBrick = setBrightnessBrick();
			...
			case 34:
				...
				{
					setState(266);
					((BrickContext) _localctx).setGhostEffectBrick = setGhostEffectBrick();
			...
			case 35:
				...
				{
					setState(269);
					((BrickContext) _localctx).setLookBrick = setLookBrick();
			...
			case 36:
				...
				{
					setState(272);
					((BrickContext) _localctx).setSizeToBrick = setSizeToBrick();
			...
			case 37:
				...
				{
					setState(275);
					((BrickContext) _localctx).setVariableBrick = setVariableBrick();
			...
			case 38:
				...
				{
					setState(278);
					((BrickContext) _localctx).setVolumeToBrick = setVolumeToBrick();
			...
			case 39:
				...
				{
					setState(281);
					((BrickContext) _localctx).setXBrick = setXBrick();
			...
			case 40:
				...
				{
					setState(284);
					((BrickContext) _localctx).setYBrick = setYBrick();
			...
			case 41:
				...
				{
					setState(287);
					((BrickContext) _localctx).showBrick = showBrick();
			...
			case 42:
				...
				{
					setState(290);
					((BrickContext) _localctx).speakBrick = speakBrick();
			...
			case 43:
				...
				{
					setState(293);
					((BrickContext) _localctx).stopAllSoundsBrick = stopAllSoundsBrick();
			...
			case 44:
				...
				{
					setState(296);
					((BrickContext) _localctx).turnLeftBrick = turnLeftBrick();
			...
			case 45:
				...
				{
					setState(299);
					((BrickContext) _localctx).turnRightBrick = turnRightBrick();
			...
			case 46:
				...
				{
					setState(302);
					((BrickContext) _localctx).waitBrick = waitBrick();
	...
	public final BroadcastBrickContext broadcastBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(27);
				setState(308);
				((BroadcastBrickContext) _localctx).message = message();
	...
	public final BroadcastWaitBrickContext broadcastWaitBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(48);
				setState(314);
				((BroadcastWaitBrickContext) _localctx).message = message();
	...
	public final ChangeBrightnessByNBrickContext changeBrightnessByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(320);
				((ChangeBrightnessByNBrickContext) _localctx).formula = formula();
				setState(321);
				match(12);
	...
	public final ChangeGhostEffectByNBrickContext changeGhostEffectByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(328);
				((ChangeGhostEffectByNBrickContext) _localctx).formula = formula();
				setState(329);
				match(12);
	...
	public final ChangeSizeByNBrickContext changeSizeByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(335);
				((ChangeSizeByNBrickContext) _localctx).formula = formula();
				setState(336);
				match(12);
	...
	public final ChangeVariableBrickContext changeVariableBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(344);
				((ChangeVariableBrickContext) _localctx).formula = formula();
	...
	public final ChangeVolumeByNBrickContext changeVolumeByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(350);
				((ChangeVolumeByNBrickContext) _localctx).formula = formula();
				setState(351);
				match(12);
	...
	public final ChangeXByNBrickContext changeXByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(357);
				((ChangeXByNBrickContext) _localctx).formula = formula();
	...
	public final ChangeYByNBrickContext changeYByNBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(7);
				setState(363);
				((ChangeYByNBrickContext) _localctx).formula = formula();
	...
	public final GlideToBrickContext glideToBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(16);
				setState(377);
				((GlideToBrickContext) _localctx).s = formula();
				...
				match(4);
				setState(382);
				((GlideToBrickContext) _localctx).x = formula();
				...
				if (_la == FUNCTION_PARAMETER_DELIMITER) {
					{
						setState(384);
						match(FUNCTION_PARAMETER_DELIMITER);
					}
				}
				...
				match(3);
				setState(388);
				((GlideToBrickContext) _localctx).y = formula();
	...
	public final GoNStepsBackBrickContext goNStepsBackBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(26);
				setState(393);
				((GoNStepsBackBrickContext) _localctx).formula = formula();
				setState(394);
				match(62);
	...
	public final IfLogicBeginBrickContext ifLogicBeginBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(39);
				setState(400);
				((IfLogicBeginBrickContext) _localctx).formula = formula();
				setState(401);
				match(58);
				setState(402);
				match(54);
	...
	public final LegoNXTMotorActionBrickContext legoNXTMotorActionBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(53);
				setState(422);
				((LegoNXTMotorActionBrickContext) _localctx).motor = motor();
				...
				match(50);
				setState(428);
				((LegoNXTMotorActionBrickContext) _localctx).formula = formula();
	...
	public final LegoNxtMotorStopBrickContext legoNxtMotorStopBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(53);
				setState(434);
				((LegoNxtMotorStopBrickContext) _localctx).motor = motor();
	...
	public final LegoNxtMotorTurnAngleBrickContext legoNxtMotorTurnAngleBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(53);
				setState(440);
				((LegoNxtMotorTurnAngleBrickContext) _localctx).motor = motor();
				brick.setMotor(((LegoNxtMotorTurnAngleBrickContext) _localctx).motor.value);
				setState(442);
				match(5);
				setState(443);
				((LegoNxtMotorTurnAngleBrickContext) _localctx).formula = formula();
	...
	public final LegoNxtPlayToneBrickContext legoNxtPlayToneBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(63);
				setState(454);
				((LegoNxtPlayToneBrickContext) _localctx).f = formula();
				...
				match(19);
				setState(460);
				((LegoNxtPlayToneBrickContext) _localctx).d = formula();
	...
	public final MoveNStepsBrickContext moveNStepsBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(31);
				setState(469);
				((MoveNStepsBrickContext) _localctx).formula = formula();
				setState(470);
				match(20);
	...
	public static class NextLookBrickContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_nextLookBrick;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).enterNextLookBrick(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).exitNextLookBrick(this);
		}
	}

	public final NextLookBrickContext nextLookBrick()
			throws RecognitionException {
		NextLookBrickContext _localctx = new NextLookBrickContext(_ctx,
				getState());
	...
	public final NoteBrickContext noteBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(40);
				setState(477);
				((NoteBrickContext) _localctx).textField = textField();
	...
	public final PlaceAtBrickContext placeAtBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(4);
				setState(483);
				((PlaceAtBrickContext) _localctx).x = formula();
				...
				match(3);
				setState(489);
				((PlaceAtBrickContext) _localctx).y = formula();
	...
	public final PlaySoundBrickContext playSoundBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(9);
				setState(494);
				((PlaySoundBrickContext) _localctx).sound = sound();
	...
	public final PointInDirectionBrickContext pointInDirectionBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(29);
				setState(500);
				((PointInDirectionBrickContext) _localctx).formula = formula();
				setState(501);
				match(34);
	...
	public final PointToBrickContext pointToBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(506);
				((PointToBrickContext) _localctx).objectName = objectName();
	...
	public final RepeatBrickContext repeatBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(22);
				setState(510);
				((RepeatBrickContext) _localctx).formula = formula();
	...
	public final SetBrightnessBrickContext setBrightnessBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(516);
				((SetBrightnessBrickContext) _localctx).formula = formula();
				setState(517);
				match(12);
	...
	public final SetGhostEffectBrickContext setGhostEffectBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(524);
				((SetGhostEffectBrickContext) _localctx).formula = formula();
				setState(525);
				match(12);
	...
	public final SetLookBrickContext setLookBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(32);
				setState(531);
				((SetLookBrickContext) _localctx).look = look();
	...
	public final SetSizeToBrickContext setSizeToBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(537);
				((SetSizeToBrickContext) _localctx).formula = formula();
				setState(538);
				match(12);
	...
	public final SetVariableBrickContext setVariableBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(545);
				((SetVariableBrickContext) _localctx).formula = formula();
	...
	public final SetVolumeToBrickContext setVolumeToBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(551);
				((SetVolumeToBrickContext) _localctx).formula = formula();
				setState(552);
				match(12);
	...
	public final SetXBrickContext setXBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(558);
				((SetXBrickContext) _localctx).formula = formula();
	...
	public final SetYBrickContext setYBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(5);
				setState(564);
				((SetYBrickContext) _localctx).formula = formula();
	...
	public static class SpeakBrickContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_speakBrick;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).enterSpeakBrick(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).exitSpeakBrick(this);
		}
	}
	...
	public final SpeakBrickContext speakBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(68);
				setState(570);
				((SpeakBrickContext) _localctx).textField = textField();
	...
	public final TurnLeftBrickContext turnLeftBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(1);
				setState(579);
				((TurnLeftBrickContext) _localctx).formula = formula();
				setState(580);
				match(34);
	...
	public final TurnRightBrickContext turnRightBrick()
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(70);
				setState(585);
				((TurnRightBrickContext) _localctx).formula = formula();
				setState(586);
				match(34);
	...
	public final WaitBrickContext waitBrick() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(48);
				setState(590);
				((WaitBrickContext) _localctx).formula = formula();
				setState(591);
				match(17);
	...
	public final ActionContext action() throws RecognitionException {
		...
		try {
			...
			{
				setState(594);
				((ActionContext) _localctx).ACTION = match(ACTION);
				((ActionContext) _localctx).value = (((ActionContext) _localctx).ACTION != null ? ((ActionContext) _localctx).ACTION
						.getText() : null);
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				do {
					...
					case 1: {
						{
							setState(598);
							((FormulaContext) _localctx).token = token();
							tokenList
									.add(((FormulaContext) _localctx).token.value);
						}
					}
						break;
					default:
	...
	public final LookContext look() throws RecognitionException {
		...
		try {
			...
			{
				setState(607);
				((LookContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				StringBuffer buf = new StringBuffer(
						(((LookContext) _localctx).USER_VARIABLE != null ? ((LookContext) _localctx).USER_VARIABLE
								.getText() : null));
	...
	public final SoundContext sound() throws RecognitionException {
		...
		try {
			...
			{
				setState(610);
				((SoundContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				StringBuffer buf = new StringBuffer(
						(((SoundContext) _localctx).USER_VARIABLE != null ? ((SoundContext) _localctx).USER_VARIABLE
								.getText() : null));
				String name = buf.substring(1, buf.length() - 1).toString();
	...
	public final ObjectNameContext objectName() throws RecognitionException {
		...
		try {
			...
			{
				setState(613);
				((ObjectNameContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				StringBuffer buf = new StringBuffer(
						(((ObjectNameContext) _localctx).USER_VARIABLE != null ? ((ObjectNameContext) _localctx).USER_VARIABLE
								.getText() : null));
				String name = buf.substring(1, buf.length() - 1).toString();
	...
	public final MessageContext message() throws RecognitionException {
		...
		try {
			...
			{
				setState(616);
				((MessageContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				((MessageContext) _localctx).value = (((MessageContext) _localctx).USER_VARIABLE != null ? ((MessageContext) _localctx).USER_VARIABLE
						.getText() : null);
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MotorContext motor() throws RecognitionException {
		...
		try {
			...
			{
				setState(619);
				((MotorContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				((MotorContext) _localctx).value = (((MotorContext) _localctx).USER_VARIABLE != null ? ((MotorContext) _localctx).USER_VARIABLE
						.getText() : null);
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class TextFieldContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_textField;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).enterTextField(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CatrobatScriptListener)
				((CatrobatScriptListener) listener).exitTextField(this);
		}
	}
	...
	public final TextFieldContext textField() throws RecognitionException {
		...
		try {
			...
			{
				setState(622);
				((TextFieldContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);
				((TextFieldContext) _localctx).value = (((TextFieldContext) _localctx).USER_VARIABLE != null ? ((TextFieldContext) _localctx).USER_VARIABLE
						.getText() : null);
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final UserVariableContext userVariable() throws RecognitionException {
		...
		try {
			...
			{
				setState(625);
				((UserVariableContext) _localctx).USER_VARIABLE = match(USER_VARIABLE);

				if (variables
						.containsKey((((UserVariableContext) _localctx).USER_VARIABLE != null ? ((UserVariableContext) _localctx).USER_VARIABLE
								.getText() : null)))
					var = variables
							.get((((UserVariableContext) _localctx).USER_VARIABLE != null ? ((UserVariableContext) _localctx).USER_VARIABLE
									.getText() : null));
				else {
					var.setName((((UserVariableContext) _localctx).USER_VARIABLE != null ? ((UserVariableContext) _localctx).USER_VARIABLE
							.getText() : null));
					variables
							.put((((UserVariableContext) _localctx).USER_VARIABLE != null ? ((UserVariableContext) _localctx).USER_VARIABLE
									.getText() : null), var);
				}
	...
	public final TokenContext token() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(628);
				_la = _input.LA(1);
				if (!(((((_la - 77)) & ~0x3f) == 0 && ((1L << (_la - 77)) & ((1L << (USER_VARIABLE - 77))
						| (1L << (NUMBER - 77))
						| (1L << (FUNCTION_NAME - 77))
						| (1L << (OPERATOR - 77))
						| (1L << (SENSOR - 77))
						| (1L << (BRACKET_OPEN - 77))
						| (1L << (BRACKET_CLOSE - 77)) | (1L << (FUNCTION_PARAMETER_DELIMITER - 77)))) != 0))) {
					_errHandler.recoverInline(this);
				}
				consume();
			}
			((TokenContext) _localctx).value = new InternToken(_input.getText(
	...
	public static final String _serializedATN = "\2\3X\u0279\4\2\t\2\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\4"
			...
			+ ".\60\62\64\668:<>@BDFHJLNPRTVXZ\\^`bdfhjlnprt