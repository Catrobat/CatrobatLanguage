...
public class CatrobatScriptParser extends Parser {
	...
	public final FormulaContext formula() throws RecognitionException {
		...
		try {
			...
			InternFormulaParser formulaParser = new InternFormulaParser(
					tokenList);
	...
	public final MessageContext message() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				StringBuffer buf = new StringBuffer(
						(((MessageContext) _localctx).USER_VARIABLE != null ? ((MessageContext) _localctx).USER_VARIABLE
								.getText() : null));
				String name = buf.substring(1, buf.length() - 1).toString();
	...
	public final MotorContext motor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				StringBuffer buf = new StringBuffer(
						(((MotorContext) _localctx).USER_VARIABLE != null ? ((MotorContext) _localctx).USER_VARIABLE
								.getText() : null));
				String name = buf.substring(1, buf.length() - 1).toString();
	...
	public final TextFieldContext textField() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				StringBuffer buf = new StringBuffer(
						(((TextFieldContext) _localctx).USER_VARIABLE != null ? ((TextFieldContext) _localctx).USER_VARIABLE
								.getText() : null));
				String name = buf.substring(1, buf.length() - 1).toString();
	...
	public final UserVariableContext userVariable() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				StringBuffer buf = new StringBuffer(_input.getText(
		...
		try {
			...
			case NUMBER:
				enterOuterAlt(_localctx, 1);
				{
					setState(628);
					match(NUMBER);
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.NUMBER, _input.getText(
									_localctx.start, _input.LT(-1)));
				}
				break;
			case OPERATOR:
				enterOuterAlt(_localctx, 2);
				{
					...
					match(OPERATOR);
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.OPERATOR,
							Operators.getInnerName(_input.getText(
									_localctx.start, _input.LT(-1))));
				}
				break;
			case SENSOR:
				enterOuterAlt(_localctx, 3);
				{
					...
					match(SENSOR);
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.SENSOR, Sensors.getInnerName(_input
			...
			case FUNCTION_NAME:
				enterOuterAlt(_localctx, 4);
				{
					...
					((TokenContext) _localctx).value = new InternToken(
							...
							Functions.getInnerName(_input.getText(
									_localctx.start, _input.LT(-1))));
				}
				break;
			case USER_VARIABLE:
				enterOuterAlt(_localctx, 5);
				{
					...
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.USER_VARIABLE, name);
				}
				break;
			case BRACKET_OPEN:
				enterOuterAlt(_localctx, 6);
				{
					...
					match(BRACKET_OPEN);
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.BRACKET_OPEN, _input.getText(
									_localctx.start, _input.LT(-1)));
				}
				break;
			case BRACKET_CLOSE:
				enterOuterAlt(_localctx, 7);
				{
					...
					match(BRACKET_CLOSE);
					((TokenContext) _localctx).value = new InternToken(
							InternTokenType.BRACKET_CLOSE, _input.getText(
									_localctx.start, _input.LT(-1)));
				}
				break;
	...
	public static final String _serializedATN = "\2\3X\u0289\4\2\t\2\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\4"
